...
<table>
    <!-- ENCABEZADO EMPRESA -->
    <tr><td colspan="13" class="cab">ESTACI&Oacute;N GOYO</td></tr>
    <tr><td colspan="13" class="cab-sub">ESTACI&Oacute;N DE SERVICIOS &amp; COMBUSTIBLES</td></tr>
    <tr><td colspan="13" class="acento"></td></tr>
    <tr><td colspan="13" class="meta">Generado el ' . date('d/m/Y') . ' a las ' . date('H:i:s') . '</td></tr>

    <!-- DATOS CLIENTE -->
    <tr>
        <td colspan="13" class="bloque">
    ...
    <!-- TÍTULO REPORTE -->
    <tr><td colspan="13" class="titulo-rep">' . $titulo . '</td></tr>
...
foreach ($vales as $vale) {
    ...
    <tr' . $par . '>
        ...
        <td class="tc">' . $venc . '</td>
        <td class="tc">' . $fp . '</td>
        <td class="tr">' . (floatval($vale['ultimo_descuento']) > 0 ? 'S/. ' . number_format(floatval($vale['ultimo_descuento']), 2) : '—') . '</td>
